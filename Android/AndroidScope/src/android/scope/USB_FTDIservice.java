...
import android.scope.ftdi.SerialInputOutputManager;
import android.scope.ftdi.UsbSerialDriver;
import android.scope.ftdi.UsbSerialProber;
...
public class USB_FTDIservice extends SignalSource {
	...
	protected void startSampling() {
		try {
			...
			// PendingIntent permissionIntent = PendingIntent.getBroadcast(this,
